...
function getMovies(){
  ...
  var url = myVars.get_url() + '3/search/movie?api_key='+ myVars.get_api_key() + '&language=en-US&page=1&query=lego';
...
function envVars(){
  var url = 'https://api.themoviedb.org/', api_key,
  read_access;
